    ...
    return {
      ...
      link: function(scope, element, attrs, ctrls) {
        ...
        scope.$watch(function optionDOMWatch(){
          ...
          //if the first option has no value and label, this must be generated by ngOptions directive. Remove it.
          if(!optionElements.eq(0).attr('value') && !optionElements.eq(0).html()) {
